...
assert(/router\.get\(\s*['"]\/capabilities['"]/.test(routes));
assert(/router\.post\(\s*['"]\/projects\/validate['"]/.test(routes));
assert(/router\.post\(\s*['"]\/runtime\/request['"]/.test(routes));
assert(/router\.post\(\s*['"]\/deploy\/request['"]/.test(routes));
