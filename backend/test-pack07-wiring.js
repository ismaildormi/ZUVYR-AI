...
for (const key of ['voice_ai','audio_transcription','audio_text_to_speech','audio_voice_chat','audio_music_generation','audio_sound_effects','audio_remix','audio_stem_separation','audio_translate_dub','audio_to_video']) assert.equal(flags[key].enabled, false);
...
console.log('PASS: Pack07 foundation remains compatible while Pack071 exposes local cleanup and keeps paid STT non-advertised');
