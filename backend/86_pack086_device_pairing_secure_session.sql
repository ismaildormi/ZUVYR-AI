...
begin
  ...
  return jsonb_build_object(
    ...
    'scopes',jsonb_build_array('heartbeat'),
...
begin
  ...
  if not found then return jsonb_build_object('success',false,'error','pack086_session_not_found'); end if;
...
begin
  ...
  values (
    ...
    jsonb_build_object('deviceId',v_device.id,'sessionsRevoked',v_sessions)
  );
