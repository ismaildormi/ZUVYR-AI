  ...
  function imageStudioView(){
    return heading('images')+
      ...
      '<div class="zs-grid">'+
        ...
        '<div class="zs-card half"><h2>V1 operation truth</h2><div class="zs-chip-row"><span class="zs-chip">Generate · engineering ready / paid live proof deferred</span><span class="zs-chip">Reference / variations · gated</span><span class="zs-chip">Edit / inpaint / expand · gated</span><span class="zs-chip">Background / relight · gated</span><span class="zs-chip">Crop / resize / canvas / layers / text / batch · backend verified</span><span class="zs-chip">Upscale · blocked</span></div></div>'+
